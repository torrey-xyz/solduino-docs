...
An MCP server is also available at `https://mcp.solduino.com/api/mcp` for AI-assisted development in Cursor, Claude Desktop, and other MCP clients. See [MCP Server](/mcp) for setup and tool reference.
...
5. Optional: connect the [MCP Server](/mcp/client-setup) for AI-assisted SDK lookup.
